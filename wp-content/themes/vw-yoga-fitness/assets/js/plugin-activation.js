jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_yoga_fitness_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-yoga-fitness-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-yoga-fitness-plugin-install');
                button.addClass('button-primary vw-yoga-fitness-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-yoga-fitness-recommended-plugins .vw-yoga-fitness-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-yoga-fitness-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-yoga-fitness-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-yoga-fitness-recommended-plugins').css('display','none');
    });
